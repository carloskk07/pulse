...
requireText("lib/release-readiness.ts", ["RELEASE_SCHEMA_VERSION = 38", 'RELEASE_SCHEMA_MIGRATION = "0038_withdrawal_settlement_integrity.sql"', 'admin.rpc("release_authenticated_read_scope_contract")', 'admin.rpc("release_withdrawal_read_contract")', 'admin.rpc("release_withdrawal_settlement_contract")', 'admin.rpc("release_reward_exchange_contract")', 'admin.rpc("release_pulse_direct_contract")', 'admin.rpc("release_hourly_pulse_pilot_contract")', '"legal-operator"', 'legalIdentity ? "pass" : "pending"', 'Deferred from the current technical-readiness scope', 'false,']);
...
requireText("supabase/migrations/0038_withdrawal_settlement_integrity.sql", ["withdrawals_paid_external_id_check", "invalid_external_id", "release_withdrawal_settlement_contract", "withdrawals_idempotency_key_key", "withdrawals_one_active_per_user_idx", "service_role", "version', 38"]);
