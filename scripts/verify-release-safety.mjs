...
requireText("app/admin/product/actions.ts", ["verifyPasswordBreachProtection", "probePwnedPasswordProtection", 'recordReleaseEvidence("supabase_auth_hardening")', "fundLaunchTreasury", "getFaucetPayBalanceReadOnly", 'admin.rpc("fund_reward_treasury"', "user_balances", "activeWithdrawals", "activeReservations", 'formData.get("confirm") === "real-funding"', "liabilityCredits", "requiredUnits", '"liability_changed"']);
