...
requireText("app/styles/app-art-direction.css", [
  ...
  "/* V11.12 — Semantic Arrival Carrier.",
  "--pc-route-vt-arrival-duration:.34s",
  "@keyframes pcSemanticCarrierArriveValue",
  "@keyframes pcSemanticCarrierArriveSignal",
  "@keyframes pcSemanticCarrierArriveNetwork",
