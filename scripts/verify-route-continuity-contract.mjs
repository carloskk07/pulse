...
requireText("app/styles/app-art-direction.css", [
  ...
  "/* V11.12 — Paired Selective Semantic Field Morph.",
  ...
  "active-view-transition-type(pc-transfer-value-signal)::view-transition-new(pc-spatial-field)",
  "active-view-transition-type(pc-transfer-signal-value)::view-transition-new(pc-spatial-field)",
  "active-view-transition-type(pc-transfer-value-network)::view-transition-new(pc-spatial-field)",
  "active-view-transition-type(pc-transfer-network-value)::view-transition-new(pc-spatial-field)",
  "active-view-transition-type(pc-transfer-signal-network)::view-transition-new(pc-spatial-field)",
  "active-view-transition-type(pc-transfer-network-signal)::view-transition-new(pc-spatial-field)",
