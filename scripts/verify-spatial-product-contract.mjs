...
requireText("components/product-interaction-layer.tsx", [
  ...
  "syncRouteTransferAuthority",
  "getRouteDimension(frame.dataset.section)",
  "getRouteDimensionFromHref",
  "frame.dataset.productResidueStrength",
  '"--pc-route-transfer-source-strength"',
  '"--pc-transfer-out-opacity"',
  '"--pc-transfer-out-scale-x"',
  '"--pc-transfer-out-blur"',
  '"--pc-transfer-bridge-scale-x"',
  '"--pc-transfer-bridge-blur"',
