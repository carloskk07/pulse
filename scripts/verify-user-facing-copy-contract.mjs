...
const requiredBySurface = new Map([
  ...
  ["app/business/page.tsx", ["Pay for <em>verified results.</em>", "Cashback partnership", "Purchase cashback", "Two integration paths"]],
  ["app/business/integration/page.tsx", ["Pulsercuit partner integration", "Cashback Partner · 01 · Tracking", "The partner never sends reward credits."]],
