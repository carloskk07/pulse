-- Bind legal-launch review evidence to the exact governed policy bundle,
-- configured operator identity and current international provider set.
...
values (
  'release_schema',
  jsonb_build_object('version', 27, 'migration', '0027_legal_launch_evidence.sql'),
  27,
  'Release readiness is fail-closed on operator identity, reviewed legal policies and international-transfer review'
)
on conflict (key) do update
