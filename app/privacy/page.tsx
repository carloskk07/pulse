...
export default function PrivacyPage() {
  return <main className="completion-page">
    ...
    <article className="policy-body shell">
      ...
      <h2>What we process</h2><p>We may process account identifiers, authentication and session records, profile information, reward and ledger events, payout status and destination references, referral activity, sponsored placement delivery and click events, security and anti-abuse signals, support requests, device or network information and technical logs needed to operate and protect the service.</p>
      <h2>Why we process it</h2><p>We use data to create and protect accounts, display the correct account state, verify rewards, maintain the ledger, process and recover payouts, prevent fraud and duplicate activity, deliver and frequency-limit sponsored placements, measure advertiser billing events, rank useful opportunities, answer support requests, investigate disputes and meet legal, accounting or compliance obligations.</p>
      <h2>Sharing and service providers</h2><p>Infrastructure, authentication, human-verification, reward, analytics where enabled, advertising-payment, and payout providers may process limited data when needed for their role. Provider-side opportunities and payouts can also be subject to the provider’s own privacy terms. Advertisers receive campaign performance information such as delivery, clicks and spend; Pulsercuit does not expose a sponsored viewer&apos;s account ID, email, Vault balance or payout destination to the advertiser. We do not treat the public marketing page as authority to create financial events.</p>
    ...
    <footer className="completion-footer shell"><span>Pulsercuit</span><div><Link href="/support">Support</Link><Link href="/rewards-policy">Rewards</Link><Link href="/advertising-policy">Advertising</Link><Link href="/terms">Terms</Link></div></footer>
  </main>;
}
