...
export default async function BusinessPage({ searchParams }: Props) {
  ...
  return (
    <main className="marketing-page business-page">
      ...
      <footer className="footer shell"><div><strong>Reward Pulse</strong><span>© 2026. Pay for verified actions.</span></div><div><Link href="/">For users</Link><Link href="#model">Model</Link><Link href="#pilot">Pilot</Link></div></footer>
    </main>
  );
}
