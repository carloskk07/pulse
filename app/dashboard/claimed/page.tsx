      ...
      <main className="pc-claim-handoff pc-v8-claim-handoff">
        ...
        <section className="pc-v8-return-stage" aria-labelledby="return-stage-title">
          <div className="pc-v8-return-core">
            ...
            <Link href="/dashboard" transitionTypes={getRouteTransitionTypesForHref("home", "/dashboard")} className="button button-light">View next reward <ArrowUpRight /></Link>
            <Link href={"/earn?claim=" + encodeURIComponent(receipt.id)} transitionTypes={getRouteTransitionTypesForHref("home", "/earn")} className="button button-secondary">Earn while you wait <ArrowUpRight /></Link>
          </div>
        ...
        <details className="admin-panel">
          ...
          <div className="pc-v8-share-panel">
            ...
            <div>
              ...
              <Link href="/progress#circuit-moments" transitionTypes={getRouteTransitionTypesForHref("home", "/progress#circuit-moments")}>Open share studio <ArrowUpRight /></Link>
            </div>
          </div>
        </details>
      </main>
