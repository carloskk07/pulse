      ...
      <div className="pc-v9-dashboard">
        ...
        <section className="app-section pc-luxe-momentum-section pc-v9-momentum">
          ...
          <div className="pc-v9-progress-deck">
            <article className="pc-v9-progress-card signal-card">
              ...
              <Link href="/progress" transitionTypes={getRouteTransitionTypesForHref("home", "/progress")}>See progress <ArrowUpRight /></Link>
            </article>
            ...
            <article className="pc-v9-progress-card vault-card">
              ...
              <Link href="/wallet" transitionTypes={getRouteTransitionTypesForHref("home", "/wallet")}>View balance <ArrowUpRight /></Link>
            </article>
            ...
            <article className="pc-v9-progress-card unlock-card">
              ...
              <Link href="/invite" transitionTypes={getRouteTransitionTypesForHref("home", "/invite")}>Open Network <ArrowUpRight /></Link>
            </article>
          </div>
        ...
        <section className="dashboard-lower-grid pc-luxe-lower-grid pc-v9-lower-grid">
          <article className="invite-card pc-luxe-turbo-card">
            ...
            <Link href="/earn" transitionTypes={getRouteTransitionTypesForHref("home", "/earn")} className="icon-button" aria-label="Open extra rewards"><ArrowUpRight /></Link>
          </article>
