...
export default async function AccountPage({ searchParams }: Props) {
  ...
  return <AppShell active="account" userLabel={profile?.handle || user.email?.split("@")[0] || "Member"}>
    <div className="app-page-head"><div><span className="app-eyebrow">Account</span><h1>Your account, without the clutter.</h1><p>Identity, support and privacy controls stay together while reward actions stay elsewhere.</p></div></div>
    ...
    <section className="completion-grid account-grid pc-v10-account-grid">
