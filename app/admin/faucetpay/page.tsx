...
const proofCopy: Record<string, string> = {
  ...
  "pack_mismatch": "The configured payout pack does not match the live unit evidence. No proof was recorded.",
};
  ...
  return (
    <AppShell active="faucetpay-admin">
      ...
      <section className="admin-kpi-grid">
        ...
        <article className={`admin-kpi ${readEvidenceCurrent ? "positive" : "danger"}`}><span>Fingerprint proof</span><strong>{readEvidenceCurrent ? "CURRENT" : "MISSING / STALE"}</strong><small>Expires automatically when read key or payout pack changes</small></article>
      </section>
