  ...
  return (
    <AppShell active="invite">
      ...
      <section className="invite-hero-card pc-luxe-invite-hero">
        ...
        <div className="pc-invite-scene" aria-hidden="true"><span>Real activity</span></div>
      </section>
      ...
      <details className="pc-share-preview pc-luxe-referral-preview"><summary><strong>Invite details</strong></summary>
        <article className="pc-share-card pc-luxe-share-poster"><small>Share preview</small><h3>Bring someone into your <em>rhythm.</em></h3><p>Progress starts when an invite becomes active.</p></article>
