...
export function getCircuitAchievements(input: {
  ...
  return [
    achievement({ id: "first-pulse", title: "First Claim", description: "Complete your first hourly faucet claim.", tone: "lime", current: claims, target: 1, unit: "Pulse" }),
    achievement({ id: "rhythm-3", title: "3-Day Streak", description: "Return and claim on three different days.", tone: "cyan", current: streak, target: 3, unit: "day" }),
    achievement({ id: "pulse-10", title: "10 Claims", description: "Complete ten hourly faucet claims.", tone: "violet", current: claims, target: 10, unit: "Pulse" }),
    achievement({ id: "signal-40", title: "Progress 40", description: "Reach the third progress rank.", tone: "cyan", current: signal, target: 40, unit: "Signal point" }),
    achievement({ id: "trust-3", title: "Verified Account", description: "Reach account trust level 3 through verified activity.", tone: "warm", current: trust, target: 3, unit: "Trust level" }),
    achievement({ id: "rhythm-7", title: "7-Day Streak", description: "Keep a seven-day return streak.", tone: "lime", current: streak, target: 7, unit: "day" }),
  ];
}
