  ...
  return (
    <section className="pc-v13-continuous-panel">
      ...
      <div className="pc-v13-continuous-actions">
        <Link href="/earn" transitionTypes={getRouteTransitionTypesForHref("home", "/earn")} className="button button-secondary">Explore extra rewards <ArrowUpRight /></Link>
        <Link href="/invite" transitionTypes={getRouteTransitionTypesForHref("home", "/invite")} className="inline-action">Open referrals <ArrowUpRight /></Link>
      </div>
    </section>
  );
}
